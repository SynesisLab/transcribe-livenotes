...
# right-click menu with Open / Quit. Quit POSTs /api/quit for a clean stop
# (the exe's exit handler takes whisper-server.exe with it) and only
# force-stops by PID if that failed. Left-click opens the app.
#
